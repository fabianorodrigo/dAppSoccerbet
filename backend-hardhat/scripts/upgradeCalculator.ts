...
function getProxyContractAddress(): string {
  ...
  return proxyAddresses.CALCULATOR_PROXY_ADDRESS;
}
...
async function main() {
  ...
  await upgrades.upgradeProxy(PROXY_CONTRACT_ADDRESS, Calculator);
  console.log("Calculator upgraded at: ", PROXY_CONTRACT_ADDRESS);
}
